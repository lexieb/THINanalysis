...
health <- get_datalake("SELECT * FROM THIN_Analysis.dbo.AleksandraBlawat_patients")
...
health$diseases <- case_when((health$has_diabetes * health$has_stroke * health$has_liverdisease * health$has_COPD * health$has_dementia * health$has_hypertension) == 1 ~ 1, 
                             ...
                             health$has_diabetes * health$has_stroke * health$has_liverdisease  * health$has_dementia * health$has_hypertension
                             health$has_diabetes * health$has_stroke * health$has_COPD * health$has_dementia * health$has_hypertension
                             (health$has_diabetes * health$has_stroke * health$has_liverdisease * health$has_COPD) == 1, ~3,
                             
                             (health$has_diabetes * health$has_stroke * health$has_COPD) == 1 ~ 2, 
                             (health$has_diabetes * health$has_stroke * health$has_liverdisease) == 1 ~ 3,
                             (health$has_diabetes * health$has_liverdisease * health$has_COPD) == 1 ~ 4,
                             (health$has_stroke * health$has_liverdisease * health$has_COPD) == 1 ~ 5, 
                             (health$has_diabetes * health$has_COPD) == 1 ~ 6,
                             (health$has_diabetes * health$has_liverdisease) == 1 ~ 7,
                             (health$has_diabetes * health$has_stroke) == 1 ~ 8,
                             health$has_diabetes == 1 ~ 9,
                             (health$has_COPD * health$has_liverdisease) == 1 ~ 10,
                             (health$has_stroke * health$has_liverdisease) == 1 ~ 11, 
                             (health$has_COPD * health$has_stroke) == 1 ~ 12,
                             health$has_COPD == 1 ~ 13, 
                             health$has_liverdisease == 1 ~ 14, 
                             TRUE ~ 0)
